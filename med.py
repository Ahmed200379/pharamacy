...
class Pharmacy:
    def __init__(self, root):
        ...
        self.root.iconbitmap(r"F:\Pharmacy_management-system-master\image\doc.ico")
        ...
        ######### pharmacy logo label #######
        img1 = Image.open(r"F:\Pharmacy_management-system-master\image\new.png")
        ...
        conn = sqlite3.connect(database=r'F:\Pharmacy_management-system-master\pharmacy.db')
        ...
        # image 1
        self.bg = ImageTk.PhotoImage(file=r"F:\Pharmacy_management-system-master\image\med.jpg")
        lbl_bg = Label(left_smallframe, image=self.bg)
        lbl_bg.place(x=370, y=165, width=200, height=150)
        # image 2
        self.bgg = ImageTk.PhotoImage(file=r"F:\Pharmacy_management-system-master\image\medi.jpg")
        ...
        # image 1
        self.bg1 = ImageTk.PhotoImage(file=r"F:\Pharmacy_management-system-master\image\co.jpg")
        lbl_bg1 = Label(right_frame, image=self.bg1)
        lbl_bg1.place(x=0, y=0, width=240, height=100)
        # image 2
        self.bg2 = ImageTk.PhotoImage(file=r"F:\Pharmacy_management-system-master\image\inject.jpg")
